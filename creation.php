...
<form method="post">
    ...
    <input type="text" name="title" value="<?php echo htmlspecialchars($quiz_title); ?>" required>

    <label for="description">Description du Quiz :</label>
    <textarea name="description" required><?php echo htmlspecialchars($quiz_description); ?></textarea>

    <label for="url_image">URL de l'image :</label>
    <input type="text" name="url_image" value="<?php echo htmlspecialchars($quiz_image_url); ?>" required>
